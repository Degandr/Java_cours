...
import Home_work_20.PageObject.Pages.*;
import Home_work_20.Steps.*;
...
public class BuyBackpackTest extends BaseTest {
    ...
    @Test
    @Description("Buy Backpack using Page Object")
    ...
    public void buyBackpackPageObjectTest() {
        ...
        log.info("Backpack was successfully added to the Cart");
        ...
        log.info("Backpack was successfully checked in the Cart");
        ...
        log.info("Your information was successfully filled");
        ...
        log.info("Checkout was successfully");
    ...
    @Test
    @Description("Buy Backpack using Steps")
    @Severity(SeverityLevel.NORMAL)
